...
extern DWORD GetProcessIDByWindow(LPCSTR windowName);
extern DWORD GetProcessIDByHandle(HANDLE handle);
extern DWORD GetProcessIDByName(LPCSTR pName);
extern HANDLE GetProcessHandleByName(LPCSTR pName, DWORD dwDesiredAccess = PROCESS_ALL_ACCESS);
